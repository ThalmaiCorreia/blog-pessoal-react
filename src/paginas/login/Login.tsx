...
function Login(){
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center'>
            ...
            <Grid xs={6} style={{
                backgroundImage: `url(https://res-3.cloudinary.com/fieldfisher/image/upload/f_jpg,q_auto/v1/sectors/technology/tech_neoncircuitboard_857021704_medium_lc5h05)`,
